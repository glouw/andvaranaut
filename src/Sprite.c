...
static const Sprite lower[] = {
    { 'a', 0, 0, 1.0f, 0.000f, 0.0000f, 200.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'b', 0, 0, 1.0f, 0.038f, 0.0032f, 200.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 }, // Dwarf.
    { 'c', 0, 0, 1.0f, 0.000f, 0.0000f, 200.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'd', 0, 0, 1.0f, 0.000f, 0.0000f,   1.0f, 0.00f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
...
upper[] = {
    { 'A', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'B', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'C', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'D', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'E', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'F', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'G', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'H', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'I', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'J', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'K', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'L', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'M', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'N', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'O', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'P', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'Q', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'R', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'S', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'T', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'U', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'V', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'W', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'X', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'Y', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
    { 'Z', 0, 0, 0.0f, 0.000f, 0.0000f, 000.0f, 0.20f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 },
};
