...
static const Sprite lower[] = {
    ...
    { 'c', 1, 1, 1.0f, 0.000f, 0.0000f,   1.0f, 0.50f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 }, // Ember.
    { 'd', 0, 0, 1.0f, 0.000f, 0.0000f,   1.0f, 0.00f, 0.0f, {0,0}, {0,0}, {0,0}, IDLE, {0,0,0,0}, {{0},0,0,0}, 0 }, // Lootbag.
