...
Item i_new(const Classification c, const int index)
{
    ...
    case     BOOK: return books     [index];
    case     BOOT: return boots     [index];
    case    CHEST: return chests    [index];
    case    FLESH: return fleshes   [index];
    case     FOOD: return foods     [index];
    ...
    case    MONEY: return monies    [index];
    case    MUSIC: return musics    [index];
    case   POTION: return potions   [index];
    case     RING: return rings     [index];
    case     ROCK: return rocks     [index];
    case   SCROLL: return scrolls   [index];
    case   SHIELD: return shields   [index];
    case SHORTWEP: return shortweps [index];
